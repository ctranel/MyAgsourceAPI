$(document).ready(
	function() {
		...
		if ( $('#set-filters').length ) $('<span class="tip-link"> <a title="Set Filters Tip" id="set-filters_tip" class="tooltip" rel="<p>For many decisions, the entire Genetic Selection Guide may include more animals than needed. If you are looking for cows to cull, you may only need to focus on the 3rd and 4th Quartiles. You can click on them and they will be the only cows listed. If you want only animals that do not have a quartile ranking, click &quot;None&quot; and &quot;Apply Filter&quot;. You can also set the filter to include certain lactation groups by clicking on them and excluding unclicked groups. The last filter is for Days in Milk (DIM). If you want to include all cows over 75 DIM, enter &quot;Between &#39;75&#39; and &#39;999&#39;.&quot; Click &quot;Apply Filter&quot; to generate a list of cows meeting the criteria you just selected. After clicking &quot;Apply Filter,&quot; any subsequent File Exports (to Excel, PDF or to the printer) will only include the cows remaining after the filter was applied. If you want to bring back all the animals on your list, simply click &quot;Reset Filter.&quot;</p>">(tip)</a></span>').appendTo('#set-filters');  
...
function set_tooltips(count){
	...
	pedigree_div = '<span class="tip-link"> <a title="Pedigree Tip" id="pedigree_tip' + count + '" class="tooltip" rel="<p>Sire and Maternal Grandsire NAAB numbers and the Dam&#39;s ID are listed. If any of these fields are blank or incorrect, provide your Field Technician with the correct data or call AgSource Customer Service.</p>">(tip)</a></span>';
