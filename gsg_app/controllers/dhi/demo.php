...
class Demo extends CI_Controller {
	...
	protected function set_herd_session_data(){
		...
		$this->session->set_userdata('herd_enroll_status_id', 4);//hard-code sample herd id, was: $this->herd->getHerdEnrollStatus($this->herd_model), $this->config->item('product_report_code'));
