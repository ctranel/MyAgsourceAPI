...
require_once APPPATH . 'libraries/Page/Content/Chart/ChartField.php';
require_once APPPATH . 'libraries/Page/Content/Chart/XAxis.php';
...
use \myagsource\Page\Content\Chart\ChartField;
 ...
 *
 */
class ChartBlock extends ReportBlock {
	/**
	 * chart_type
	 * @var string
	 **/
