...
require_once(APPPATH . 'libraries/Page/Content/Table/Header/TableHeaderCell.php');
...
class TableHeader {
	...
	public function __construct(iReportBlock $block, $header_groups, SupplementalFactory $supplemental_factory = null){
