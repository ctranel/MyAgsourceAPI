...
class Dam_model extends CI_Model {
	...
	public function getCowArray($herd_code, $serial_num){
		...
		->join('rpm.dbo.report_cow_id_1 id', 'c.herd_code = id.herd_code AND c.serial_num = id.serial_num')
