...
if(isset($lact_num)):
	if($lact_num > 1):?>
		<a class="button incr-lact-tests" data-target="#graphs" data-toggle="tab" href="<?php echo site_url('dhi/cow_lookup/graphs/' . $serial_num . '/' . ($lact_num - 1)); ?>">Previous Lactation</a>
<?php 
	endif;
	if($lact_num < $curr_lact_num):?>
		<a class="button incr-lact-tests" data-target="#graphs" data-toggle="tab" href="<?php echo site_url('dhi/cow_lookup/graphs/' . $serial_num . '/' . ($lact_num + 1)); ?>">Next Lactation</a>
<?php
	endif;
endif; ?>
