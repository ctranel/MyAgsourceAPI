...
<body style="font-family: Helvetica,Arial,Verdana,sans-serif">
	...
	<p>Thank you for using <?php echo $this->config->item("product_name"); ?>.  If you have any questions or concerns, please contact us at <?php echo $this->config->item('cust_serv_email', 'ion_auth'); ?> or <?php echo $this->config->item('cust_serv_phone', 'ion_auth'); ?>.</p>
</body>
</html>