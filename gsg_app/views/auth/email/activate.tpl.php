...
<body style="font-family: Helvetica,Arial,Verdana,sans-serif">
	...
	<p><?php echo $this->config->item("product_name"); ?> gives you access to a number of <?php echo $this->config->item("cust_serv_company"); ?> products with one convenient login.  You are enrolled in a <?php echo $this->config->item("cust_serv_phone"); ?> day free trial during which you will have access to all content available on MyAgSource.</p>
