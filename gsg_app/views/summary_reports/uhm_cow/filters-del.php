			...
			case 'block': ?>
					<?php if(isset($arr_pages) && is_array($arr_pages)):
						...
						foreach($arr_pages as $k=>$e):
							if(!empty($k)): ?>
									<span class="filter-checkbox"><?php echo form_radio(array('name'=>'block', 'id'=>'block' . $e['url_segment']), $e['url_segment'], ($filter_selected['block'] == $e['url_segment'])); echo $e['name']; ?></span>
							<?php endif;
						endforeach;
						echo form_fieldset_close();
					endif;
