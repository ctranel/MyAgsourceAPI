			...
			case 'quartile': ?>
				<p class = "filter-group">
					...
					<span class="filter-checkbox">
						<?php echo form_checkbox(array('name'=>'decision_guide_qtile_num[]', 'id'=>'decision_guide_qtile_num0'), 'NULL', in_array('0', $filter_selected['decision_guide_qtile_num']) !== false); ?>
						None&nbsp;&nbsp;
					</span>
					<span class="filter-checkbox">
