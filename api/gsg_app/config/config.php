...
*/
	switch (ENVIRONMENT){
		...
		case 'production':
			...
			$config['base_url_assets']	= "https://myagsource.com/";
			$config['pdf_path']	= "/opt/data/agsource/all_pdf_reports/";
		break;
		default:
...
|--------------------------------------------------------------------------
|
| Product-specific configurations used throughout application:
|
|	
*/
	...
	*/
	...
	switch (ENVIRONMENT)
	{
		...
		case 'production':
			...
			$config['field_email']          = "asr@agsource.com,emss@crinet.com,tss@agsource.com";
...
|
*/
$config['encryption_key'] = "wdtgRDWYGBdet347537unb-trdFDE65k";
...
$config['sess_table_name']		= 'users.dbo.as_sessions';
$config['sess_match_ip']		= FALSE;
$config['sess_match_useragent']	= TRUE;
$config['sess_time_to_update']	= 3000; //default is 300
