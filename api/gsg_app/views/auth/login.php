...
<div class='mainInfo'>
  ...
  <!-- <div id="info-message">MyAgsource will be down for maintenance from 1:00 to 3:00am on June 28, 2015.  We apologize for any inconvenience.</div> -->
	<div class="row">
		<div class="col-sm-6">
			<div class="box login">
				<h2>DHI</h2>
			    <h3>Dairy, Milk and Animal Health Diagnostics</h3>
			    <p class="emph">DHI Members, register for a FREE <?php echo $trial_days; ?> day trial of <?php echo $this->config->item('product_name'); ?>, <?php echo anchor('auth/create_user', 'click here'); ?>!</p>
