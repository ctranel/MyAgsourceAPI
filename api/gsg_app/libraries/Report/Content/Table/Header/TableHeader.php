...
class TableHeader {
	...
	public function __construct(iReport $report, $header_groups, SupplementalFactory $supplemental_factory = null){
	...
	public function columnCount(){
		return count($this->report->reportFields());
	}
	...
	public function getTableHeaderStructure($alt_header = null){
		...
		if($this->report->hasPivot()){
			...
			$this->columns = $this->report->reportFields();
		}
