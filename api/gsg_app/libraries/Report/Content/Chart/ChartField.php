...
class ChartField extends ReportField {
	...
	/**
	 */
	public function __construct($id, $name, DbField $data_field, $category_id, $is_displayed, $display_format, $aggregate, $is_sortable, $chart_type, $axis_index, $trend_type, $field_group, $header_supp = null, $data_supp = null, $field_group_ref_key = null) {
