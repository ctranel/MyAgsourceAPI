...
class Ion_auth_parent_model extends CI_Model
{
	/**
	 ...
	 * @author Mathew
	 **/
	public function deactivate($id = NULL, $record_messages = true)
	{
		...
		$return = $this->db->affected_rows() == 1;
		if ($return && $record_messages)
			$this->set_message('deactivate_successful');
		elseif($record_messages)
			$this->set_error('deactivate_unsuccessful');
	...
	**/
	...
	public function set_hook($event, $name, $class, $method, $arguments=array())
	{
